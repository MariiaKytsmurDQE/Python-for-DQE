...
class Publication:
    ...
    def publishing(self):
        ...
        try:
            ...
            print(f'\nERROR. Incorrect publishing data_type. Available data_types (News, Private Ad, Useful Tips). Error: {e}')
            return False
...
class PublFromFile:
    def __init__(self, cnt_sent, filename, path='C:/Python/Python-for-DQE/Hometask_8/'):
...
class PublFromJsonFile():
    def __init__(self, count_elements=0, filename='',
                 path='C:/Python/Python-for-DQE/Hometask_8/'):
